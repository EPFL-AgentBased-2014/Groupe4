...
to go 
  ...
  set nb-groups (init-individus / moyen)
  set nb-groups floor nb-groups
...
to compter_voisins
  ...
  set voisins count individus in-radius vision ;5 ????????????????????? _ - - - - - -- - - - - -- - - - - - - - - - - - -
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot nb-groups"
