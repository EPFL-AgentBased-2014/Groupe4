...
"" ""
PENS
"Happy-regroup" 1.0 0 -2674135 true "" "plot moyenne5-happy-regroup * 100"
"Happy-pollution" 1.0 0 -13791810 true "" "plot moyenne5-happy-pollution * 100"
"Happy-centers" 1.0 0 -13840069 true "" "plot moyenne5-happy-centers * 100"
...
1378
467
Taille moyenne des groupes - pollution
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy moyenne-individus pc_pollution"
...
"" ""
PENS
"Happy" 1.0 0 -16777216 true "" "plot moyenne5-happy * 100"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy happy-regroup * 100 happy-centers * 100"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy happy-centers * 100 happy-pollution * 100"
...
1380
160
Ce modèle montre le comportement d'individus à la quête du bonheur. Le bonheur est fonction de 3 caractéristiques:\n1° le nombre d'individus visibles dans un rayon \"vision\". S'il est compris entre 0 et 15, alors on est graduellement plus heureux plus ce nombre augmente, l'inverse entre 15 et 30, et au delà de ça, on cherche à bouger dans un rayon de 2 pas autours de soi pour trouver une meilleure situation\n2° la pollution qui nous entoure. Moins il y en a, plus on est content. Le seuil de tolérance est fixé aléatoirement entre 0 et pollution-tolerate. En se déplaçant, l'individu pollue (déchets); il laisse une trace derrière lui. Plus la case est polluée, plus elle devient noire. Le sol possède une capacité de rétention de la pollution: soil-pollution-retention.\n3° les centres d'intérêts (marché, école, gallerie d'art...). Si un centre d'intérêt se trouve dans le rayon de vision de l'individu, alros il est content. Ces centres d'intérêts possèdent une vision. Plus ils \"voient loin\", plus les gens sont \"appelés\" à s'y rendre, ainsi qu'une influence, plus l'influence est grande, plus les gens seront captivés et resteront proche de ce centre d'intérêt.
11
0.0
1
...
995
231
Condition d'équilibre dynamique: formation d'un gros point noir ---->\n(voir les 4 tableaux ci-contre)
11
0.0
1
